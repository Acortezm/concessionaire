...
const AdminLogin = () =>{
    return (
        ...
        <div class="h-full bg-gradient-to-tl from-blue-300 to-orange-300 w-full py-16 px-4">
            <div class="flex flex-col items-center justify-center">
            <img src={logo} alt= "logo" className = "rounded-lg h-36 w-36 flex items-center justify-center" />
                <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800">Inicia Sesion como Administrador</p>
                    <Link to = "/SellerLogin">
                    <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500"><a href="javascript:void(0)"   class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Cambiar Vendedor</a></p>
                   </Link>
                    ...
                    <div class="w-full flex items-center justify-between py-5">
                        ...
                        <div class="mt-8">
                            <Link to = "/admin">
                            <BotonExtra>Iniciar Sesión </BotonExtra></Link>
                           </div>
                </div>
            </div>
        </div>
