    ...
    return (
        <div className='absolute inset-y-0 right-32'>
            ...
            <div className="flex items-center justify-center">
                ...
                < BotonExtra > Lista de productos </BotonExtra>
            </div>
                ...
                <tbody>
                    ...
                    <td>
                        <div className="flex items-center justify-center">
                         ...
                         <Link to="/Admin/EditProduct"><button className="bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-1 
        focus:ring-gray-700 py-2 px-2 border rounded-lg border-gray-200 flex items-center w-8 font text-white justify-center"><i className="far fa-edit"></i></button></Link>
                        </div>
                    </td>
        ...
        focus:ring-gray-700 py-2 px-2 border rounded-lg border-gray-200 flex items-center w-8 font text-white justify-center" ><i className="far fa-trash-alt"></i></button>
                        </div>
                    </td>
