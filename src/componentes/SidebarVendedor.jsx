...
const SidebarVendedor = () => {
    return (
            <nav className = 'xl:w-2/6 w-2/6 bg-gradient-to-tl from-yellow-300 to-orange-300 h-screen flex items-center flex-col fixed'>
            <div><Perfile ></Perfile>
            <h2 className= "text-sm text-center text-gray-600 mt-5 font-bold " >PERFIL DE VENDEDOR</h2>
            </div>
            <Link to = '/vendedor'><BotonPrincipal>Inicio</BotonPrincipal></Link>
